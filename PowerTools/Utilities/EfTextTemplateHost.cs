...
namespace Microsoft.DbContextPackage.Utilities
{
    ...
    {
        public List<Tuple<string,string>> EntitiesDictionary { get; set; }
 
        public IDictionary<string, string> DocumentDictionary { get; set; } 
        public string DocumentDescription { get; set; }
        public string EntityDescription { get; set; }

        public string EntityPascalName { get; set; }

        public string EntityMaperPascalName { get; set; }
